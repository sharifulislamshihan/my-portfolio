...
const AboutMe = () => {
    return (
        <div className="my-40">
            <h3 className="text-white text-5xl font-paragraph font-semibold text-center mb-20">
                React-ive & Creative
            </h3>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 md:mx-10 lg:mx-20 xl:mx-40">
                <div>
                    <img src="" alt="" />
                </div>
